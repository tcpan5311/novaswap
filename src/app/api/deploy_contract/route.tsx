...
export async function POST() {
  ...
  try {
    ...
    const erc20MintableFactory = new ethers.ContractFactory(ERC20Mintable.abi, ERC20Mintable.bytecode.object, wallet)
    const uniswapV3FactoryFactory = new ethers.ContractFactory(UniswapV3Factory.abi, UniswapV3Factory.bytecode.object, wallet)

    //Ethereum contract deploying and minting
    const ethereumContract = await erc20MintableFactory.deploy('Ether', 'ETH', 18)
    ...
    const usdcContract = await erc20MintableFactory.deploy('USDC', 'USDC', 18)
    ...
    const uniswapContract = await erc20MintableFactory.deploy('Uniswap', 'UNI', 18)
    ...
    const uniswapV3FactoryContract = await uniswapV3FactoryFactory.deploy()
